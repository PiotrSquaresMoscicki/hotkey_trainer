...
class Action {
    ...
    shift;
    alt;
    constructor(name, key, ctrl = false, shift = false, alt = false) {
        this.name = name;
        this.key = key;
        this.ctrl = ctrl;
        this.shift = shift;
...
class Model {
    ...
    registerKey(key, ctrl, shift, alt) {
        const requiredOperation = this.getNextRequiredOperation();
    ...
    generateOperationsSet(allowedOperations, numberOfOperations) {
        this.operationsSet = [];
